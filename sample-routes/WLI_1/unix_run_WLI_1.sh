...
echo ""
echo "================================================================"
echo "  Thawing Field Analyzer | WLI_1 Sample Run"
echo "================================================================"
echo "  This script runs the WLI_1 benchmark route."
echo ""
echo "  The tfa-environment-settings.json in this folder is"
echo "  pre-configured for WLI_1:"
echo "    Potential  : WLI  (Peebles & Vilenkin 1999)"
echo "    Parameters : alpha = 1.0 |  phi_inf = 1.30"
...
python "$DIR/run_WLI_1.py"

echo ""
echo "================================================================"
echo "  WLI_1 run complete."
